...
import { Animated, FlatList, Image, Pressable, SafeAreaView, ScrollView, StyleSheet, Text, View, ImageBackground } from 'react-native';
...
import AddNewIncomeExpenditure from './components/AddNewIncomeExpenditure';
...
export default function CurrentIncomeExpenditureScreen(props: navigationInterface) {
    ...
    return (
        <SafeAreaView style={[{ flex: 1, gap: 16 }, global_styles.container]}>
